...
| سیستم خارجی | وضعیت | نوع یکپارچه‌سازی | داده‌های مبادله‌شده | فرکانس |
|-------------|--------|------------------|----------------------|--------|
| گیت‌هاب | اصلی | دوطرفه | کامیت‌ها، Issues | لحظه‌ای |
| جیرا | افزونه | یکطرفه | وظایف، پروژه‌ها | روزانه |
| اسلک | افزونه | یکطرفه | اعلان‌ها | لحظه‌ای |
| گوگل درایو | افزونه | دوطرفه | فایل‌ها، اسناد | لحظه‌ای |
| مایکروسافت تیمز | افزونه | یکطرفه | پیام‌ها، جلسات | لحظه‌ای |
